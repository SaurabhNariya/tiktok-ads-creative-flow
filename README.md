...
**Overview:**  
A frontend-only demo that simulates a TikTok Ads creative flow: **OAuth**, **conditional validation**, and **clear API error handling**.  
*Not a full Ads Manager.*
...
- Create a **TikTok Developer account** and enable **Ads access**
- Create an **Ads App** in the TikTok dashboard; note:
  - **Client Key**
  - **Client Secret**
- Set **Redirect URI** to:
http://localhost:5173/oauth/callback
...
- Add **`client_key`** to project config  

### OAuth Flow
- Redirect → receive **authorization code**
- Exchange code *(POST `/api/auth/exchange`)*
- Store **access token** in **localStorage**

---

## ⚠️ OAuth Errors Handled
...
UI shows **friendly messages**; **raw API JSON is hidden**.
...
➡️ All rules enforced **client-side before submission**.
